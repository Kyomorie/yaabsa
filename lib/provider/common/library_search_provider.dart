...
typedef LibrarySearchProviderArgs = ({
  String query,
  int? limit,
  String? libraryId,
});
...
final librarySearchProvider = FutureProvider.autoDispose
    .family<SearchLibrary?, LibrarySearchProviderArgs>((ref, args) async {
      final api = ref.watch(absApiProvider);
      final libraryId =
          args.libraryId ?? ref.watch(selectedLibraryProvider)?.id;
      ...
      try {
        ...
        logger(
          'Error searching library: $error\n$stack',
          tag: 'LibrarySearchProvider',
