...
_MediaProgress _$MediaProgressFromJson(
  ...
  mediaItemType: const MediaItemTypeConverter().fromJson(
    json['mediaItemType'] as String,
  ),
  ...
  currentTime: const AllowNullableForDoubleConverter().fromJson(
    json['currentTime'],
  ),
...
Map<String, dynamic> _$MediaProgressToJson(
  ...
  'mediaItemType': const MediaItemTypeConverter().toJson(
    instance.mediaItemType,
  ),
  ...
  'currentTime': const AllowNullableForDoubleConverter().toJson(
    instance.currentTime,
  ),
  'isFinished': instance.isFinished,
  'hideFromContinueListening': instance.hideFromContinueListening,
  'ebookLocation': _$JsonConverterToJson<dynamic, String>(
    instance.ebookLocation,
    const IntToStringConverter().toJson,
  ),
