...
_LibraryAuthors _$LibraryAuthorsFromJson(Map<String, dynamic> json) =>
    _LibraryAuthors(
      results:
          (json['results'] as List<dynamic>?)
              ?.map((e) => LibraryAuthor.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const <LibraryAuthor>[],
...
Map<String, dynamic> _$LibraryAuthorsToJson(_LibraryAuthors instance) =>
    <String, dynamic>{
