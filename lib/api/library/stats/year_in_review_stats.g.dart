...
_YearInReviewNamedStat _$YearInReviewNamedStatFromJson(
  Map<String, dynamic> json,
) => _YearInReviewNamedStat(
  name: json['name'] as String?,
  time: jsonIntFromDynamic(json['time']),
);

Map<String, dynamic> _$YearInReviewNamedStatToJson(
  _YearInReviewNamedStat instance,
) => <String, dynamic>{'name': instance.name, 'time': instance.time};

_YearInReviewGenreStat _$YearInReviewGenreStatFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$YearInReviewGenreStatToJson(
  _YearInReviewGenreStat instance,
) => <String, dynamic>{'genre': instance.genre, 'time': instance.time};

_YearInReviewMonthStat _$YearInReviewMonthStatFromJson(
  Map<String, dynamic> json,
) => _YearInReviewMonthStat(
  month: jsonIntFromDynamic(json['month']),
  time: jsonIntFromDynamic(json['time']),
);

Map<String, dynamic> _$YearInReviewMonthStatToJson(
  _YearInReviewMonthStat instance,
) => <String, dynamic>{'month': instance.month, 'time': instance.time};

_YearInReviewBookStat _$YearInReviewBookStatFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$YearInReviewBookStatToJson(
  _YearInReviewBookStat instance,
) => <String, dynamic>{
  'id': instance.id,
...
_YearInReviewStats _$YearInReviewStatsFromJson(
  Map<String, dynamic> json,
) => _YearInReviewStats(
  ...
  totalPodcastListeningTime: jsonIntFromDynamic(
    json['totalPodcastListeningTime'],
  ),
  topAuthors:
      (json['topAuthors'] as List<dynamic>?)
          ?.map(
            (e) => YearInReviewNamedStat.fromJson(e as Map<String, dynamic>),
          )
          .toList() ??
  ...
  topGenres:
      (json['topGenres'] as List<dynamic>?)
          ?.map(
            (e) => YearInReviewGenreStat.fromJson(e as Map<String, dynamic>),
          )
          .toList() ??
      const <YearInReviewGenreStat>[],
  mostListenedNarrator: json['mostListenedNarrator'] == null
      ? null
      : YearInReviewNamedStat.fromJson(
          json['mostListenedNarrator'] as Map<String, dynamic>,
        ),
  mostListenedMonth: json['mostListenedMonth'] == null
      ? null
      : YearInReviewMonthStat.fromJson(
          json['mostListenedMonth'] as Map<String, dynamic>,
        ),
  ...
  longestAudiobookFinished: json['longestAudiobookFinished'] == null
      ? null
      : YearInReviewBookStat.fromJson(
          json['longestAudiobookFinished'] as Map<String, dynamic>,
        ),
  booksWithCovers:
      (json['booksWithCovers'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  finishedBooksWithCovers:
      (json['finishedBooksWithCovers'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  ...
  booksAddedWithCovers:
      (json['booksAddedWithCovers'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
...
Map<String, dynamic> _$YearInReviewStatsToJson(_YearInReviewStats instance) =>
    <String, dynamic>{
