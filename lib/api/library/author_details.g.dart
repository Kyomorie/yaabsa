    ...
    _AuthorDetails(
      ...
      series:
          (json['series'] as List<dynamic>?)
              ?.map(
                (e) => AuthorSeriesGroup.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
...
_AuthorSeriesGroup _$AuthorSeriesGroupFromJson(Map<String, dynamic> json) =>
    _AuthorSeriesGroup(
      id: json['id'] as String,
      name: json['name'] as String,
      items:
...
Map<String, dynamic> _$AuthorSeriesGroupToJson(_AuthorSeriesGroup instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
