...
_UpdateLibrarySettingsRequest _$UpdateLibrarySettingsRequestFromJson(
  ...
  markAsFinishedTimeRemaining: jsonIntFromDynamic(
    json['markAsFinishedTimeRemaining'],
  ),
  markAsFinishedPercentComplete: jsonDoubleFromDynamic(
    json['markAsFinishedPercentComplete'],
  ),
...
Map<String, dynamic> _$UpdateLibrarySettingsRequestToJson(
  _UpdateLibrarySettingsRequest instance,
) => <String, dynamic>{
