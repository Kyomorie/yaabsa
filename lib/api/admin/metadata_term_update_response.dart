...
abstract class MetadataTermUpdateResponse with _$MetadataTermUpdateResponse {
  const factory MetadataTermUpdateResponse({
    @JsonKey(name: 'numItemsUpdated', fromJson: jsonIntRequiredFromDynamic)
    @Default(0)
    int numItemsUpdated,
  ...
  factory MetadataTermUpdateResponse.fromJson(Map<String, dynamic> json) =>
      _$MetadataTermUpdateResponseFromJson(json);
}
