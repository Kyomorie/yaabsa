...
abstract class AdminAuthenticationSettings with _$AdminAuthenticationSettings {
  ...
  const factory AdminAuthenticationSettings({
    ...
    @JsonKey(name: 'authActiveAuthMethods')
    @Default(<String>['local'])
    List<String> authActiveAuthMethods,
    @JsonKey(name: 'authOpenIDIssuerURL') String? authOpenIdIssuerUrl,
    @JsonKey(name: 'authOpenIDAuthorizationURL')
    ...
    @JsonKey(name: 'authOpenIDTokenSigningAlgorithm')
    String? authOpenIdTokenSigningAlgorithm,
    @JsonKey(name: 'authOpenIDButtonText') String? authOpenIdButtonText,
    @JsonKey(name: 'authOpenIDAutoLaunch')
    @Default(false)
    bool authOpenIdAutoLaunch,
    @JsonKey(name: 'authOpenIDAutoRegister')
    @Default(false)
    bool authOpenIdAutoRegister,
    @JsonKey(name: 'authOpenIDMatchExistingBy')
    String? authOpenIdMatchExistingBy,
    @JsonKey(name: 'authOpenIDMobileRedirectURIs')
    @Default(<String>[])
    List<String> authOpenIdMobileRedirectUris,
    @JsonKey(name: 'authOpenIDGroupClaim') String? authOpenIdGroupClaim,
    @JsonKey(name: 'authOpenIDAdvancedPermsClaim')
    String? authOpenIdAdvancedPermsClaim,
    @JsonKey(name: 'authOpenIDSubfolderForRedirectURLs')
    String? authOpenIdSubfolderForRedirectUrls,
    @JsonKey(name: 'authOpenIDSamplePermissions')
    String? authOpenIdSamplePermissions,
