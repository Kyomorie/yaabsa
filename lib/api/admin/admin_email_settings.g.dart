...
_AdminEmailEreaderDevice _$AdminEmailEreaderDeviceFromJson(
...
Map<String, dynamic> _$AdminEmailEreaderDeviceToJson(
  _AdminEmailEreaderDevice instance,
) => <String, dynamic>{
  'name': instance.name,
...
_AdminEmailSettings _$AdminEmailSettingsFromJson(Map<String, dynamic> json) =>
    _AdminEmailSettings(
      ...
      ereaderDevices:
          (json['ereaderDevices'] as List<dynamic>?)
              ?.map(
                (e) =>
                    AdminEmailEreaderDevice.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          const <AdminEmailEreaderDevice>[],
    );

Map<String, dynamic> _$AdminEmailSettingsToJson(_AdminEmailSettings instance) =>
    <String, dynamic>{
      'id': instance.id,
      'host': instance.host,
      'port': instance.port,
