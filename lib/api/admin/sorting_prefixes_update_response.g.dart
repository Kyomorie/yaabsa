...
_SortingPrefixesUpdateResponse _$SortingPrefixesUpdateResponseFromJson(
...
Map<String, dynamic> _$SortingPrefixesUpdateResponseToJson(
  _SortingPrefixesUpdateResponse instance,
) => <String, dynamic>{
