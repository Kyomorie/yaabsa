...
_QuickMatchLibraryItemResponse _$QuickMatchLibraryItemResponseFromJson(
...
Map<String, dynamic> _$QuickMatchLibraryItemResponseToJson(
  _QuickMatchLibraryItemResponse instance,
) => <String, dynamic>{
