...
@freezed
abstract class BatchQuickMatchLibraryItemsResponse
    with _$BatchQuickMatchLibraryItemsResponse {
  const factory BatchQuickMatchLibraryItemsResponse({
    @JsonKey(name: 'success') @Default(false) bool success,
    @JsonKey(name: 'updates')
    @JsonKey(fromJson: jsonIntFromDynamic)
    @Default(0)
    int updates,
    @JsonKey(name: 'unmatched')
    @JsonKey(fromJson: jsonIntFromDynamic)
    @Default(0)
    int unmatched,
  ...
  factory BatchQuickMatchLibraryItemsResponse.fromJson(
