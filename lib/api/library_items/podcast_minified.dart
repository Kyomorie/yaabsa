...
abstract class PodcastMinified with _$PodcastMinified {
  const factory PodcastMinified({
    ...
    int? numEpisodes,
    @JsonKey(name: 'autoDownloadEpisodes', fromJson: jsonBoolFromDynamic)
    bool? autoDownloadEpisodes,
    @JsonKey(name: 'autoDownloadSchedule') String? autoDownloadSchedule,
    @JsonKey(name: 'lastEpisodeCheck', fromJson: jsonIntFromDynamic)
    int? lastEpisodeCheck,
    @JsonKey(name: 'maxEpisodesToKeep', fromJson: jsonIntFromDynamic)
    int? maxEpisodesToKeep,
    @JsonKey(name: 'maxNewEpisodesToDownload', fromJson: jsonIntFromDynamic)
