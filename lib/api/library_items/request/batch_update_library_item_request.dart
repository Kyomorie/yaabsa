...
@freezed
abstract class BatchUpdateLibraryItemRequest
    with _$BatchUpdateLibraryItemRequest {
  @JsonSerializable(includeIfNull: false, explicitToJson: true)
  const factory BatchUpdateLibraryItemRequest({
    @JsonKey(name: 'id') required String id,
    @JsonKey(name: 'mediaPayload')
    required UpdateLibraryItemMediaRequest mediaPayload,
