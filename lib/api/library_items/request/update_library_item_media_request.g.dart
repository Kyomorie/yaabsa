...
_UpdateLibraryItemMediaRequest _$UpdateLibraryItemMediaRequestFromJson(
  Map<String, dynamic> json,
) => _UpdateLibraryItemMediaRequest(
  metadata: json['metadata'] == null
      ? null
      : UpdateLibraryItemMediaMetadataPatch.fromJson(
...
Map<String, dynamic> _$UpdateLibraryItemMediaRequestToJson(
  _UpdateLibraryItemMediaRequest instance,
) => <String, dynamic>{
...
_$UpdateLibraryItemMediaMetadataPatchFromJson(Map<String, dynamic> json) =>
    _UpdateLibraryItemMediaMetadataPatch(
...
Map<String, dynamic> _$UpdateLibraryItemMediaMetadataPatchToJson(
  _UpdateLibraryItemMediaMetadataPatch instance,
) => <String, dynamic>{
