...
_PodcastMinified _$PodcastMinifiedFromJson(Map<String, dynamic> json) =>
    _PodcastMinified(
      metadata: PodcastMetadata.fromJson(
      ...
      maxNewEpisodesToDownload: jsonIntFromDynamic(
        json['maxNewEpisodesToDownload'],
      ),
      size: jsonIntFromDynamic(json['size']),
    );

Map<String, dynamic> _$PodcastMinifiedToJson(_PodcastMinified instance) =>
    <String, dynamic>{
