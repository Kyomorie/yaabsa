...
_PodcastFeedResponse _$PodcastFeedResponseFromJson(Map<String, dynamic> json) =>
    _PodcastFeedResponse(
      podcast: PodcastFeed.fromJson(json['podcast'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PodcastFeedResponseToJson(
  _PodcastFeedResponse instance,
) => <String, dynamic>{'podcast': instance.podcast};
...
_PodcastFeedEpisode _$PodcastFeedEpisodeFromJson(Map<String, dynamic> json) =>
    _PodcastFeedEpisode(
      ...
      enclosure: json['enclosure'] == null
          ? null
          : PodcastFeedEpisodeEnclosure.fromJson(
      ...
      chapters:
          (json['chapters'] as List<dynamic>?)
              ?.map(
                (e) => PodcastFeedEpisodeChapter.fromJson(
...
Map<String, dynamic> _$PodcastFeedEpisodeToJson(_PodcastFeedEpisode instance) =>
    <String, dynamic>{
      'title': instance.title,
...
_PodcastFeedEpisodeEnclosure _$PodcastFeedEpisodeEnclosureFromJson(
...
Map<String, dynamic> _$PodcastFeedEpisodeEnclosureToJson(
  _PodcastFeedEpisodeEnclosure instance,
) => <String, dynamic>{
  'url': instance.url,
  'type': instance.type,
...
_PodcastFeedEpisodeChapter _$PodcastFeedEpisodeChapterFromJson(
  Map<String, dynamic> json,
) => _PodcastFeedEpisodeChapter(
  title: json['title'] as String?,
  start: jsonDoubleFromDynamic(json['start']),
);

Map<String, dynamic> _$PodcastFeedEpisodeChapterToJson(
  _PodcastFeedEpisodeChapter instance,
) => <String, dynamic>{'title': instance.title, 'start': instance.start};
