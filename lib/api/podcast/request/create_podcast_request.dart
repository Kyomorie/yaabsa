...
abstract class CreatePodcastRequest with _$CreatePodcastRequest {
  ...
  factory CreatePodcastRequest.fromJson(Map<String, dynamic> json) =>
      _$CreatePodcastRequestFromJson(json);
}
...
abstract class CreatePodcastMedia with _$CreatePodcastMedia {
  ...
  factory CreatePodcastMedia.fromJson(Map<String, dynamic> json) =>
      _$CreatePodcastMediaFromJson(json);
}
...
abstract class CreatePodcastMetadata with _$CreatePodcastMetadata {
  const factory CreatePodcastMetadata({
    ...
    String? itunesId,
    @JsonKey(name: 'itunesArtistId', fromJson: jsonStringFromDynamic)
  ...
  factory CreatePodcastMetadata.fromJson(Map<String, dynamic> json) =>
      _$CreatePodcastMetadataFromJson(json);
}
