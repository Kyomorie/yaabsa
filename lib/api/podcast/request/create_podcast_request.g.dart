...
_CreatePodcastRequest _$CreatePodcastRequestFromJson(
...
Map<String, dynamic> _$CreatePodcastRequestToJson(
  _CreatePodcastRequest instance,
) => <String, dynamic>{
  'path': instance.path,
...
_CreatePodcastMedia _$CreatePodcastMediaFromJson(Map<String, dynamic> json) =>
    _CreatePodcastMedia(
      metadata: CreatePodcastMetadata.fromJson(
        json['metadata'] as Map<String, dynamic>,
      ),
      autoDownloadEpisodes: json['autoDownloadEpisodes'] as bool? ?? false,
    );

Map<String, dynamic> _$CreatePodcastMediaToJson(_CreatePodcastMedia instance) =>
    <String, dynamic>{
      'metadata': instance.metadata,
      'autoDownloadEpisodes': instance.autoDownloadEpisodes,
    };

_CreatePodcastMetadata _$CreatePodcastMetadataFromJson(
  Map<String, dynamic> json,
  ...
  genres: json['genres'] == null
      ? const <String>[]
      : jsonStringListFromDynamic(json['genres']),
...
Map<String, dynamic> _$CreatePodcastMetadataToJson(
  _CreatePodcastMetadata instance,
) => <String, dynamic>{
