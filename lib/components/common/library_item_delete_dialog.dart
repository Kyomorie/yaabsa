...
Future<LibraryItemDeleteMode?> showLibraryItemDeleteDialog({
  ...
  return showDialog<LibraryItemDeleteMode>(
    ...
    builder: (dialogContext) {
      return LibraryItemDeleteDialog(
        ...
        child: Column(
          ...
          children: [
            ...
            LibraryItemDeleteOptionTile(
              ...
              onTap: () =>
                  Navigator.of(context).pop(LibraryItemDeleteMode.absOnly),
            ),
            const SizedBox(height: 8),
            LibraryItemDeleteOptionTile(
              ...
              onTap: () =>
                  Navigator.of(context)
                      .pop(LibraryItemDeleteMode.absAndFileSystem),
            ),
          ],
        ),
      ),
...
class LibraryItemDeleteOptionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final onSurfaceColor = destructive
