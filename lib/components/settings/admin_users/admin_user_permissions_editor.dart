        ...
        child: Column(
          ...
          children: [
            ...
            _PermissionSwitch(
              ...
              enabled: enabled,
              onChanged: (value) =>
                  onChanged(permissions.copyWith(download: value)),
            ),
            _PermissionSwitch(
              label: 'Can update',
              ...
              enabled: enabled,
              onChanged: (value) =>
                  onChanged(permissions.copyWith(update: value)),
            ),
            _PermissionSwitch(
              label: 'Can delete',
              ...
              enabled: enabled,
              onChanged: (value) =>
                  onChanged(permissions.copyWith(delete: value)),
            ),
            _PermissionSwitch(
              label: 'Can upload',
              ...
              enabled: enabled,
              onChanged: (value) =>
                  onChanged(permissions.copyWith(upload: value)),
            ),
            _PermissionSwitch(
              ...
              enabled: enabled,
              onChanged: (value) =>
                  onChanged(permissions.copyWith(createEreader: value)),
            ),
            _PermissionSwitch(
              ...
              enabled: enabled,
              onChanged: (value) =>
                  onChanged(permissions.copyWith(accessExplicitContent: value)),
            ),
          ],
        ),
      ),
